import { ISubmission, ISubmissionDataForTestCases, Submission, SubmissionStatus } from "../models/submission.model";
...
export interface ISubmissionRepository {
  ...
  updateStatus(id: string, status: SubmissionStatus, submissionData: ISubmissionDataForTestCases): Promise<ISubmission | null>;
}
...
export class SubmissionRepository implements ISubmissionRepository {
  ...
  async updateStatus(id: string, status: SubmissionStatus, submissionData: ISubmissionDataForTestCases): Promise<ISubmission | null>{
